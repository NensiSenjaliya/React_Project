...
const ProductList = () => {
    ...
    //     let result = await fetch("http://localhost:5000/api/product/products");
    ...
    const deleteprod = async (id) => {
        let results = await fetch(`${API_URL}/delete/${id}`, {
            method: 'Delete'
          });
                            ...
                            <div className="card shadow-lg border-0">
                                ...
                                <div className="card-body">
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            navigate("/update/"+pro._id, { state: pro })
